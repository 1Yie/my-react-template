...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		<div
			className={cn(
				`border-input bg-background ring-ring/24
				...
				bg-clip-padding text-base shadow-xs transition-shadow
				...
				has-[textarea]:h-auto sm:text-sm dark:bg-clip-border
				dark:not-has-[input:disabled,textarea:disabled]:not-has-[input:focus-visible,textarea:focus-visible]:not-has-[input[aria-invalid],textarea[aria-invalid]]:before:shadow-[0_-1px_--theme(--color-white/8%)]
...
function InputGroupText({ className, ...props }: React.ComponentProps<'span'>) {
	return (
		<span
			className={cn(
				`text-muted-foreground line-clamp-1 flex items-center gap-2
				[&_svg]:pointer-events-none [&_svg]:-mx-0.5
