...
function DialogViewport({
	...
	return (
		<DialogPrimitive.Viewport
			className={cn(
				`fixed inset-0 z-50 grid grid-rows-[1fr_auto] justify-items-center pt-12
		...
		<DialogPortal>
			...
			<DialogViewport>
				<DialogPrimitive.Popup
					className={cn(
						`bg-popover text-popover-foreground relative row-start-2 flex
						max-h-full min-h-0 w-full min-w-0 flex-col border-t bg-clip-padding
