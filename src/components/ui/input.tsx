...
function Input({
	...
	return (
		...
		>
			<InputPrimitive
				className={cn(
					`placeholder:text-muted-foreground/72 h-8.5 w-full min-w-0
					rounded-[inherit] px-[calc(--spacing(3)-1px)] leading-8.5 outline-none
					...
					props.type === 'file' &&
						`text-muted-foreground file:text-foreground file:me-3
