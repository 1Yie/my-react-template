			...
			>
				<TooltipPrimitive.Popup
					className={cn(
						...
						origin-(--transform-origin) rounded-md border bg-clip-padding
						text-xs text-balance shadow-md shadow-black/5
						...
						data-instant:duration-0 data-starting-style:scale-98
						data-starting-style:opacity-0 dark:bg-clip-border
				...
				>
					<TooltipPrimitive.Viewport
						className="relative size-full overflow-clip
							...
							**:data-previous:truncate **:data-previous:opacity-100
