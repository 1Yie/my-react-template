	...
	return (
		...
		>
			<ScrollAreaPrimitive.Viewport
				className={cn(
					`transition-shadows focus-visible:ring-ring
					focus-visible:ring-offset-background h-full overscroll-contain
					rounded-[inherit] outline-none focus-visible:ring-2
	...
	return (
		<ScrollAreaPrimitive.Scrollbar
			className={cn(
				...
				data-hovering:duration-100 data-scrolling:opacity-100
				data-scrolling:delay-0 data-scrolling:duration-100
